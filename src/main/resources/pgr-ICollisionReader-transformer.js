...
//					print("Transforming method " + node.name);
				...
				list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/github/lorenzopapi/pgr/handler/CollisionReaderMixinHandler", "filterShapes", "(Ljava/util/stream/Stream;Lnet/minecraft/entity/Entity;Lnet/minecraft/util/math/AxisAlignedBB;)Ljava/util/stream/Stream;"));
